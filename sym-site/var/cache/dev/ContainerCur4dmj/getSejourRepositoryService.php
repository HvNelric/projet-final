...
// Returns the private 'App\Repository\SejourRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\SejourRepository.php';

return $this->services['App\Repository\SejourRepository'] = new \App\Repository\SejourRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
