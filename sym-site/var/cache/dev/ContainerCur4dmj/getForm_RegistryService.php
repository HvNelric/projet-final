...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\InscriptionType' => function () {
    return ${($_ = isset($this->services['App\Form\InscriptionType']) ? $this->services['App\Form\InscriptionType'] : $this->services['App\Form\InscriptionType'] = new \App\Form\InscriptionType()) && false ?: '_'};
