...
return $this->services['maker.file_manager'] = new \Symfony\Bundle\MakerBundle\FileManager(${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : $this->services['filesystem'] = new \Symfony\Component\Filesystem\Filesystem()) && false ?: '_'}, new \Symfony\Bundle\MakerBundle\Util\AutoloaderUtil(), $this->targetDirs[3]);
