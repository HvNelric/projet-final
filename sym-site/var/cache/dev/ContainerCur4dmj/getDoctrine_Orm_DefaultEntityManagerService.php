...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\PrefRepository' => function () {
    return ${($_ = isset($this->services['App\Repository\PrefRepository']) ? $this->services['App\Repository\PrefRepository'] : $this->load('getPrefRepositoryService.php')) && false ?: '_'};
}, 'App\\Repository\\RegionRepository' => function () {
    return ${($_ = isset($this->services['App\Repository\RegionRepository']) ? $this->services['App\Repository\RegionRepository'] : $this->load('getRegionRepositoryService.php')) && false ?: '_'};
...
}, 'App\\Repository\\SejourRepository' => function () {
    return ${($_ = isset($this->services['App\Repository\SejourRepository']) ? $this->services['App\Repository\SejourRepository'] : $this->load('getSejourRepositoryService.php')) && false ?: '_'};
