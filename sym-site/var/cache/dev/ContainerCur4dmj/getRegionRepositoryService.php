...
return $this->services['App\Repository\RegionRepository'] = new \App\Repository\RegionRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
