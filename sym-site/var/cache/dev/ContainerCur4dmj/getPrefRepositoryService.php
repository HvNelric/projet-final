...
// Returns the private 'App\Repository\PrefRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\PrefRepository.php';

return $this->services['App\Repository\PrefRepository'] = new \App\Repository\PrefRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
