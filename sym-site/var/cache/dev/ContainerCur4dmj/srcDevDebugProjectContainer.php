...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = array(
            ...
            'app\\controller\\searchcontroller' => 'App\\Controller\\SearchController',
            'app\\controller\\securitycontroller' => 'App\\Controller\\SecurityController',
            'app\\form\\inscriptiontype' => 'App\\Form\\InscriptionType',
            'app\\repository\\prefrepository' => 'App\\Repository\\PrefRepository',
            'app\\repository\\regionrepository' => 'App\\Repository\\RegionRepository',
            'app\\repository\\reservationrepository' => 'App\\Repository\\ReservationRepository',
            'app\\repository\\sejourrepository' => 'App\\Repository\\SejourRepository',
        ...
        $this->fileMap = array(
            ...
            'App\\Form\\InscriptionType' => 'getInscriptionTypeService.php',
            'App\\Repository\\PrefRepository' => 'getPrefRepositoryService.php',
            'App\\Repository\\RegionRepository' => 'getRegionRepositoryService.php',
            'App\\Repository\\ReservationRepository' => 'getReservationRepositoryService.php',
            'App\\Repository\\SejourRepository' => 'getSejourRepositoryService.php',
            ...
            'security.user.provider.concrete.db' => 'getSecurity_User_Provider_Concrete_DbService.php',
        ...
        $this->privates = array(
            ...
            'App\\Repository\\PrefRepository' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('L6dU3DXeQh', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OM9IoufjWp', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GyIW1NyYW1', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('L667SWmWrU', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rko+nD2wkY', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('main', 'app_security_logout', 'logout', '_csrf_token', NULL, NULL);
