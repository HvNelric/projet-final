...
class srcDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/api')) {
            ...
            if (0 === strpos($pathinfo, '/api/sejours')) {
                // api_sejours_get_collection
                if (preg_match('#^/api/sejours(?:\\.(?P<_format>[^/]++))?$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'api_sejours_get_collection')), array (  '_controller' => 'api_platform.action.get_collection',  '_format' => NULL,  '_api_resource_class' => 'App\\Entity\\Sejour',  '_api_collection_operation_name' => 'get',));
                    if (!in_array($canonicalMethod, array('GET'))) {
                        $allow = array_merge($allow, array('GET'));
                        goto not_api_sejours_get_collection;
                    }

                    return $ret;
                }
                not_api_sejours_get_collection:

                // api_sejours_post_collection
                if (preg_match('#^/api/sejours(?:\\.(?P<_format>[^/]++))?$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'api_sejours_post_collection')), array (  '_controller' => 'api_platform.action.post_collection',  '_format' => NULL,  '_api_resource_class' => 'App\\Entity\\Sejour',  '_api_collection_operation_name' => 'post',));
                    if (!in_array($requestMethod, array('POST'))) {
                        $allow = array_merge($allow, array('POST'));
                        goto not_api_sejours_post_collection;
                    }

                    return $ret;
                }
                not_api_sejours_post_collection:

                // api_sejours_get_item
                if (preg_match('#^/api/sejours/(?P<id>[^/\\.]++)(?:\\.(?P<_format>[^/]++))?$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'api_sejours_get_item')), array (  '_controller' => 'api_platform.action.get_item',  '_format' => NULL,  '_api_resource_class' => 'App\\Entity\\Sejour',  '_api_item_operation_name' => 'get',));
                    if (!in_array($canonicalMethod, array('GET'))) {
                        $allow = array_merge($allow, array('GET'));
                        goto not_api_sejours_get_item;
                    }

                    return $ret;
                }
                not_api_sejours_get_item:

                // api_sejours_delete_item
                if (preg_match('#^/api/sejours/(?P<id>[^/\\.]++)(?:\\.(?P<_format>[^/]++))?$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'api_sejours_delete_item')), array (  '_controller' => 'api_platform.action.delete_item',  '_format' => NULL,  '_api_resource_class' => 'App\\Entity\\Sejour',  '_api_item_operation_name' => 'delete',));
                    if (!in_array($requestMethod, array('DELETE'))) {
                        $allow = array_merge($allow, array('DELETE'));
                        goto not_api_sejours_delete_item;
                    }

                    return $ret;
                }
                not_api_sejours_delete_item:

                // api_sejours_put_item
                if (preg_match('#^/api/sejours/(?P<id>[^/\\.]++)(?:\\.(?P<_format>[^/]++))?$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'api_sejours_put_item')), array (  '_controller' => 'api_platform.action.put_item',  '_format' => NULL,  '_api_resource_class' => 'App\\Entity\\Sejour',  '_api_item_operation_name' => 'put',));
                    if (!in_array($requestMethod, array('PUT'))) {
                        $allow = array_merge($allow, array('PUT'));
                        goto not_api_sejours_put_item;
                    }

                    return $ret;
                }
                not_api_sejours_put_item:
        ...
        if (0 === strpos($pathinfo, '/sejours')) {
            // app_sejour_index
            if ('/sejours' === $trimmedPathinfo) {
            ...
            // app_sejour_details
            if (0 === strpos($pathinfo, '/sejours/detail') && preg_match('#^/sejours/detail(?:/(?P<id>[^/]++))?$#sD', $pathinfo, $matches)) {
        ...
        if (0 === strpos($pathinfo, '/user')) {
            ...
            if (preg_match('#^/user/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'app_user_userbyid')), array (  '_controller' => 'App\\Controller\\UserController::userById',));
            }
